...
var MONGODB_URI = 'mongodb://USERNAME:PASS@ds163679.mlab.com:63679/beeple';
...
mongodb.MongoClient.connect(MONGODB_URI, function(err, database){
	...
	collRoomNames = db.collection('RoomNames');
});
...
cron.schedule('0 18 * * 1-5', function() {    //'*/2 */1 * * 1-5' elke 2 minuten 
	var array = [];
	var responsible;
...
var routes = function(Checkin, Checkout, Event, User, Sandwiche, Room, RoomName, secret){
	...
	var roomNameController = require('../controllers/roomNameController.js')(RoomName);
...
appRouter.route('/roomNames')
	.post(roomNameController.post)
	.get(roomNameController.get);

appRouter.route('/roomNames/:id')
	.put(roomNameController.putId)
	.delete(roomNameController.deleteId)
	.get(roomNameController.getId);
